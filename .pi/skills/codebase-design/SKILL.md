...
- **Abstractions are properties of the consumer modules** An abstraction is a property of a module defining what it expects from the interface of any module satisfying it.
- **The deletion test.** Imagine deleting the module. If complexity vanishes, it was a pass-through. If complexity reappears across N callers, it was earning its keep.
- **The interface is the test surface.** Callers and tests cross the same seam. If you want to test *past* the interface, the module is probably the wrong shape and should be reconsidered.
...
1. **Accept dependencies, don't create them.**
   ...
   ```python
    # Testable
    def processOrder(order, paymentGateway):
        ...
